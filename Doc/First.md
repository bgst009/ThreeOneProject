...
**do while** 先执行一次循环，然后判断是否满足条件 goto

**while** 先 goto 到 判断语句 然后判断是否满足条件 goto
...
1. 将 `setDate(&date, type, (int)&data);` 改为 `setDate(&date, type, data);`

![image-20200814190221523](https://gitee.com/bgst007/markdownPicUrl/raw/master/20200814190221.png)